...
def get_meta_status(db: Session = Depends(get_db), current_user: User = Depends(get_current_active_user)):
    ...
    limitations = "Meta không cho phép quét tự do toàn bộ Facebook/Instagram công khai. Nope24 chỉ thu thập dữ liệu trong phạm vi tài khoản, Page hoặc Instagram Business được kết nối và các quyền được cấp."
