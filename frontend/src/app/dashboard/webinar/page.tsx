...
import { Award, Calendar, Users, PlayCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900 to-[#030614] border border-blue-500/30 p-12 text-center flex flex-col items-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-6 relative z-10 max-w-3xl leading-tight">
          Get a Social Listening Certificate with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Brand24</span>
        </h1>
