    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white dark:bg-[#050A15] rounded-2xl shadow border border-gray-200 dark:border-white/10 p-8">
        <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-100 dark:border-white/10">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">Thêm lịch gửi báo cáo</h2>
            <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">Hệ thống sẽ tổng hợp số liệu và gửi thẳng vào hộp thư.</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-600 dark:text-slate-700 dark:text-gray-300">Tần suất gửi</label>
              <select
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-600 dark:text-slate-700 dark:text-gray-300">Loại báo cáo</label>
              <select
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-600 dark:text-slate-700 dark:text-gray-300">Email nhận báo cáo (cách nhau bởi dấu phẩy)</label>
            <input
              type="text"
              value={form.emails}
          ...
          <div className="pt-2 flex justify-end gap-3">
            <button
              ...
              className="px-6 py-2.5 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-700 dark:text-slate-900 dark:text-white rounded-lg font-medium transition-colors"
            >
              Hủy
            </button>
            <button
          ...
          <div className="space-y-3">
            {schedules.map(s => (
              <div key={s.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/5">
                <div>
                  <p className="text-sm font-medium text-slate-900 dark:text-white">{FREQ_LABELS[s.frequency] || s.frequency}</p>
                  <p className="text-xs text-slate-500 dark:text-gray-400 mt-0.5">{TYPE_LABELS[s.report_type] || s.report_type}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-500 dark:text-gray-400 hover:text-red-500 transition-colors"
                    title="Xóa lịch"
                  >
