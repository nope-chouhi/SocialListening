...
export default function EmailSettings() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-white tracking-wide">Cấu hình Email</h2>
        <p className="text-sm text-gray-400 mt-1">Cấu hình SMTP để gửi email thông báo</p>
      </div>
      ...
      <div className="bg-[#111827] border border-gray-800 rounded-xl shadow-sm p-6 space-y-6">
        ...
        {/* TLS/SSL Options */}
        <div className="flex items-center space-x-8 pt-6 border-t border-gray-800">
          <label className="flex items-center cursor-pointer group">
            ...
            />
            <span className="ml-3 text-sm font-medium text-gray-300 group-hover:text-white transition-colors">Use TLS (Port 587)</span>
          </label>
          ...
          <label className="flex items-center cursor-pointer group">
            <input
              ...
              className="w-4 h-4 rounded bg-[#111827] border-gray-600 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-gray-900 transition-colors"
            />
            <span className="ml-3 text-sm font-medium text-gray-300 group-hover:text-white transition-colors">Use SSL (Port 465)</span>
          </label>
        </div>
