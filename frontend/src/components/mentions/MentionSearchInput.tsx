...
export function MentionSearchInput({ value, onChange, onClear, placeholder, className = '' }: MentionSearchInputProps) {
  const { t } = useLanguage();
  const inputPlaceholder = placeholder || t('mentions.searchPlaceholder');
